...
pub struct Dispatcher {
    ...
    pub use_ref: Function, // pub use_callback: *const dyn Fn(),
}

unsafe impl Send for Dispatcher {}

impl Dispatcher {
    pub fn new(use_state: Function, use_effect: Function, use_ref: Function) -> Self {
        Dispatcher {
            use_state,
            use_effect,
            use_ref,
...
pub unsafe fn update_dispatcher(args: &JsValue) {
    ...
    CURRENT_DISPATCHER.current = Some(Box::new(Dispatcher::new(use_state, use_effect, use_ref)))
}
