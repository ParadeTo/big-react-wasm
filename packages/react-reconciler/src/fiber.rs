...
impl FiberNode {
    ...
    pub fn derive_state_node(fiber: Rc<RefCell<FiberNode>>) -> Option<Rc<dyn Any>> {
        ...
        // match fiber.clone().unwrap().clone().borrow().tag.clone() {
        //     WorkTag::FunctionComponent => todo!(),
        //     WorkTag::HostRoot => {
        //         log!(
        //             "derive_state_node, HostRoot {:?}",
        //             fiber.clone().unwrap().clone().borrow().state_node.clone()
        //         );
        //         fiber.clone().unwrap().clone().borrow().state_node.clone()
        //     }
        //     WorkTag::HostComponent => {
        //         log!(
        //             "derive_state_node, HostComponent {:?}",
        //             fiber.clone().unwrap().clone().borrow().state_node.clone()
        //         );
        //         fiber.clone().unwrap().clone().borrow().state_node.clone()
        //     }
        ...
        log!(
            "derive_state_node, {:?} {:?} {:?}",
            state_node.is_none(),
            fiber.clone().borrow().tag.clone(),
            fiber.clone().borrow().key,
        );
